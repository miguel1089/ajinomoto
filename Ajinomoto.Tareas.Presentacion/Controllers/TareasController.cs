...
using Ajinomoto.Tareas.Presentacion.Data;

namespace Ajinomoto.Tareas.Presentacion.Controllers
{
    public class TareasController : Controller
    {
        private AjinomotoTareasPresentacionContext db = new AjinomotoTareasPresentacionContext();
